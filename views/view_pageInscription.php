...
<body>
    <article class="pageConnexion">
        <section class="connexionGauche">
            ...
            <div class="formBienvenue">INSCRIPTION</div>
            <form action="../controllers/controller_pageInsciption.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="submit" value="Inscription avec Google">
            </form>
